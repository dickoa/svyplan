...
Survey sample size determination, precision analysis, optimal allocation,
stratification, and power analysis for R.
...
```{r power-plot, fig.width=7, fig.height=4, fig.alt="Power increases with total sample size. Dashed reference lines mark 80 percent power at the required sample size for detecting a change from 70 to 75 percent with a design effect of 2."}
